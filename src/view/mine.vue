    ...
    <div class="bottomTabs" swipable fixed="true">
      <van-tabbar>
        <van-tabbar-item replace to="/home" name="home" icon="home-o"
          >首页</van-tabbar-item
        >
        <van-tabbar-item replace to="/games" name="setting" icon="setting-o"
          >游戏</van-tabbar-item
        >
      </van-tabbar>
    </div>
      ...
      gameList: [
        {
          ...
          gameDescription: "made by mihayo, most popular nowadays "
        },
        {
          id: 2,
          ...
          name: "王者荣耀",
          gameType: "moba",
          gameDescription: "most popular among teenagers"
        },
        {
          id: 3,
        ...
        },
        {
          ...
          name: "愤怒的小鸟",
          gameType: "relax",
          gameDescription: "3D made by Ultrasty"
        },
        {
          id: 5,
          ...
          name: "合成西瓜",
          gameType: "relax",
          gameDescription: "made by shinenine"
        }
      ],
      normal: [
        {
